                  ...
                  child: ListView(
                    children: [
                      ...
                      const Padding(
                        ...
                        child: Center(
                          child: TxtStyle("إنشاء حساب جديد", 18, Colors.black,
                              FontWeight.bold),
                        ),
                      ),
                      //text fields
                      ...
                      ConditionalBuilder(
                          condition: signupState is! SignupLoadingState,
                          ...
                          builder: (context) => Padding(
                                ...
                                child: CustomButton(
                                    text: "التالي",
                                    onTap: () {
                                      if (signUpOneFormKey.currentState!
                                          .validate()) {
                      ...
                      TextButton(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              const TxtStyle("الدخول", 12, Colors.black,
                                  FontWeight.normal),
                            ],
                          )),
                    ],
